 ...
 * <tt>StringBuilder</tt> class should generally be used in preference to this
		...
		java.io.Serializable, CharSequence
{
	 ...
	 * string. The initial capacity of the string buffer is <code>16</code> plus
	 ...
	 * buffer is <code>16</code> plus the length of the
	 * <code>CharSequence</code> argument.
	 * <p>
	 * If the length of the specified <code>CharSequence</code> is less than or
	 * equal to zero, then an empty buffer of capacity <code>16</code> is
	 * returned.
	 *
	 * @param seq
	 ...
	 * are appended to this <tt>StringBuffer</tt>.
	 * <p>
	 * Let <i>n</i> be the length of the old character sequence, the one
	 * contained in the <tt>StringBuffer</tt> just prior to execution of the
	 * <tt>append</tt> method. Then the character at index <i>k</i> in the new
	 ...
	 * equal to the character at index <i>k-n</i> in the argument
	 * <code>sb</code>.
	 * <p>
	 * This method synchronizes on <code>this</code> (the destination) object
	 * but does not synchronize on the source (<code>sb</code>).
	 *
	 * @param sb
	 ...
	 * <p>
	 * The characters of the <code>CharSequence</code> argument are appended, in
	 ...
	 * synchronize on the source (<code>s</code>).
	 *
	 * <p>
	 ...
	 *
	 * @serialField
	 *                  value char[] The backing character array of this
	 *                  StringBuffer.
	 * @serialField
	 *                  count int The number of characters in this StringBuffer.
	 * @serialField
	 *                  shared boolean A flag indicating whether the backing
	 *                  array is shared. The value is ignored upon
	 *                  deserialization.
	 */
