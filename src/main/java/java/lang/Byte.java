 ...
 * {@code byte} to a {@code String} and a {@code String} to a {@code byte}, as
 * well as other constants and methods useful when dealing with a {@code byte}.
 *
...
public final class Byte extends Number implements Comparable<Byte>
{
	...
	/**
	 * A constant holding the minimum value a {@code byte} can have,
	 * -2<sup>7</sup>.
	 */
	public static final byte MIN_VALUE = -128;

	/**
	 * A constant holding the maximum value a {@code byte} can have,
	 * 2<sup>7</sup>-1.
	 */
	 ...
	 * value. The resulting {@code byte} value is returned.
	 *
	 * <p>
	...
	/**
	 * Parses the string argument as a signed decimal {@code byte}. The
	 * characters in the string must all be decimal digits, except that the
	 * first character may be an ASCII minus sign {@code '-'} (
	 * <code>'&#92;u002D'</code>) to indicate a negative value or an ASCII plus
	 * sign {@code '+'} (<code>'&#92;u002B'</code>) to indicate a positive
	 * value. The resulting {@code byte} value is returned, exactly as if the
	 ...
	 * parsed as by the {@code Byte.parseByte} method with the indicated radix
