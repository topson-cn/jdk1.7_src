/*
 * Copyright (c) 2003, 2010, Oracle and/or its affiliates. All rights reserved. ORACLE
...
/**
 * A <tt>Readable</tt> is a source of characters. Characters from a <tt>Readable</tt> are made
 * available to callers of the read method via a {@link java.nio.CharBuffer CharBuffer}.
 *
 * @since 1.5
 */
