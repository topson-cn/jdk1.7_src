...
public class Runtime
{
	 ...
	 *             If a security manager is present and its <tt>
	 *             {@link SecurityManager#checkExit checkExit}</tt> method does
	 *             not permit exiting with the specified status
	 *
	 ...
	 * @param status
	 *            Termination status. By convention, a nonzero status code
	 *            indicates abnormal termination. If the <tt>
	 *            {@link Runtime#exit exit}</tt> (equivalently, <tt>
	 *            {@link System#exit(int) System.exit}</tt>) method has already
	 *            been invoked then this status code will override the status
	 *            code passed to that method.
	 *
	 * @throws SecurityException
	 *             If a security manager is present and its <tt>
	 *             {@link SecurityManager#checkExit checkExit}</tt> method does
	 *             not permit an exit with the specified status
	 *
	 * @see #exit
	 * @see #addShutdownHook
	 * @see #removeShutdownHook
	...
	/**
	 * Loads the specified filename as a dynamic library. The filename argument
	 * must be a complete path name, (for example
	 ...
	 * where library files are conventionally obtained. The details of this
	 * process are implementation-dependent. The mapping from a library name to
	 * a specific filename is done in a system-specific manner.
	 * <p>
	 * First, if there is a security manager, its <code>checkLink</code> method
