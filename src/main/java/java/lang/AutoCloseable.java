/*
 * Copyright (c) 2009, 2011, Oracle and/or its affiliates. All rights reserved. ORACLE
...
public interface AutoCloseable {
   ...
   * this {@code close} method is <em>not</em> required to be idempotent. In other words, calling
   * this {@code close} method more than once may have some visible side effect, unlike
