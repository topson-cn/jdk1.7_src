 ...
 * nearest the exact result; such a method is <i>correctly rounded</i>. A
 ...
 * correctly rounded. Instead, for the {@code Math} class, a larger error bound
 ...
 * <i>semi-monotonic</i>: whenever the mathematical function is non-decreasing,
