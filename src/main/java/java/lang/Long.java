...
/**
 * The {@code Long} class wraps a value of the primitive type {@code long} in an
 * object. An object of type {@code Long} contains a single field whose type is
 * {@code long}.
 *
 * <p>
 * In addition, this class provides several methods for converting a
 * {@code long} to a {@code String} and a {@code String} to a {@code long}, as
 * well as other constants and methods useful when dealing with a {@code long}.
 *
 * <p>
...
public final class Long extends Number implements Comparable<Long>
{
	 ...
	 * (base&nbsp;16) with no extra leading {@code 0}s. If the unsigned
	 * magnitude is zero, it is represented by a single zero character
	 * {@code '0'} (<code>'&#92;u0030'</code>); otherwise, the first character
	 * of the representation of the unsigned magnitude will not be the zero
	 ...
	 *
	 * <p>
	 * Note that neither the character {@code L} (<code>'&#92;u004C'</code>) nor
	 * {@code l} (<code>'&#92;u006C'</code>) is permitted to appear at the end
	 * of the string as a type indicator, as would be permitted in Java
	 * programming language source code - except that either {@code L} or
	 ...
	 * sign {@code '+'} (<code>'&#92;u002B'</code>) to indicate a positive
	 * value. The resulting {@code long} value is returned, exactly as if the
	 * argument and the radix {@code 10} were given as arguments to the
	 ...
	 * parsed as by the {@code Long.parseLong} method with the indicated radix
	 ...
	 * value of this property is then interpreted as a {@code long} value and a
	 * {@code Long} object representing this value is returned. Details of
	 ...
	 * per the {@code Long.decode} method, and a {@code Long} object
	 ...
	 *
	 * <p>
	 * Note that, in every case, neither {@code L} (<code>'&#92;u004C'</code>)
	 * nor {@code l} (<code>'&#92;u006C'</code>) is permitted to appear at the
	 * end of the property value as a type indicator, as would be permitted in
