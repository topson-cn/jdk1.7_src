...
/**
 * The {@code Short} class wraps a value of primitive type {@code short} in an
 * object. An object of type {@code Short} contains a single field whose type is
 * {@code short}.
 *
 * <p>
...
public final class Short extends Number implements Comparable<Short>
{
	...
	/**
	 * A constant holding the minimum value a {@code short} can have,
	 * -2<sup>15</sup>.
	 */
	public static final short MIN_VALUE = -32768;

	/**
	 * A constant holding the maximum value a {@code short} can have,
	 * 2<sup>15</sup>-1.
	 */
	 ...
	 * value. The resulting {@code short} value is returned.
	 *
	 * <p>
	...
	/**
	 * Parses the string argument as a signed decimal {@code short}. The
	 * characters in the string must all be decimal digits, except that the
	 * first character may be an ASCII minus sign {@code '-'} (
	 * <code>'&#92;u002D'</code>) to indicate a negative value or an ASCII plus
	 * sign {@code '+'} (<code>'&#92;u002B'</code>) to indicate a positive
	 * value. The resulting {@code short} value is returned, exactly as if the
	 ...
	 * parsed as by the {@code Short.parseShort} method with the indicated radix
