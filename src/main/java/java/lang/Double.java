...
public final class Double extends Number implements Comparable<Double>
{
	 ...
	 * of the result is '{@code -}' (<code>'&#92;u002D'</code>); if the sign is
	...
	public static String toHexString(double d)
	{
		...
		else
		{
			...
			else
			{
				...
				// E_min -1).
				answer.append("p"
						+ (subnormal ? DoubleConsts.MIN_EXPONENT : FpUtils
								.getExponent(d)));
			}
	...
	/**
	 * Returns the value of this {@code Double} as a {@code byte} (by casting to
	 * a {@code byte}).
	 *
	...
	/**
	 * Returns the value of this {@code Double} as a {@code short} (by casting
	 * to a {@code short}).
	 *
	 * @return the {@code double} value represented by this object converted to
	 *         type {@code short}
	...
	/**
	 * Returns the value of this {@code Double} as an {@code int} (by casting to
	 * type {@code int}).
	 *
	 * @return the {@code double} value represented by this object converted to
	 *         type {@code int}
	...
	/**
	 * Returns the value of this {@code Double} as a {@code long} (by casting to
	 * type {@code long}).
	 *
	 * @return the {@code double} value represented by this object converted to
	 *         type {@code long}
	 ...
	 * <ul>
	 * <li>
	 * {@code Double.NaN} is considered by this method to be equal to itself and
	 * greater than all other {@code double} values (including
	 * {@code Double.POSITIVE_INFINITY}).
	 * <li>
	 * {@code 0.0d} is considered by this method to be greater than
	 * {@code -0.0d}.
	 * </ul>
