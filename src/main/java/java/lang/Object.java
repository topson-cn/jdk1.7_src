...
public class Object
{
	 ...
	 *                {@code clone} method can also throw this exception to
	 ...
	 * @exception IllegalArgumentException
	 *                if the value of timeout is negative or the value of nanos
	 ...
	 * ready to be finalized. The {@code finalize} method may take any action,
	 * including making this object available again to other threads; the usual
	 * purpose of {@code finalize}, however, is to perform cleanup actions
