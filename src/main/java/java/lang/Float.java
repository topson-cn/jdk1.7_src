...
public final class Float extends Number implements Comparable<Float>
{
	 ...
	 * the value returned by {@code Math.getExponent(Float.MAX_VALUE)}.
	 *
	 * @since 1.6
	 */
	 ...
	 * equal to the value returned by {@code Math.getExponent(Float.MIN_NORMAL)}
	 * .
	 *
	 * @since 1.6
	 */
	 ...
	 * first character of the result is '{@code -}' (<code>'&#92;u002D'</code>);
	 ...
	 * such that 10<sup><i>n</i> </sup>&le; <i>m</i> {@literal <}
	 * 10<sup><i>n</i>+1</sup>; then let <i>a</i> be the mathematically exact
	...
	/**
	 * Returns the value of this {@code Float} as a {@code byte} (by casting to
	 * a {@code byte}).
	 *
	...
	/**
	 * Returns the value of this {@code Float} as a {@code short} (by casting to
	 * a {@code short}).
	 *
	 * @return the {@code float} value represented by this object converted to
	 *         type {@code short}
	...
	/**
	 * Returns the value of this {@code Float} as an {@code int} (by casting to
	 * type {@code int}).
	 *
	 * @return the {@code float} value represented by this object converted to
	 *         type {@code int}
	...
	/**
	 * Returns value of this {@code Float} as a {@code long} (by casting to type
	 * {@code long}).
	 *
	 * @return the {@code float} value represented by this object converted to
	 *         type {@code long}
	 ...
	 *
	 * @return the {@code float} value represented by this object is converted
	 *         to type {@code double} and the result of the conversion is
	 *         returned.
	 */
	 ...
	 * ) when applied to primitive {@code float} values:
	 *
	 * <ul>
	 * <li>
	 * {@code Float.NaN} is considered by this method to be equal to itself and
	 * greater than all other {@code float} values (including
	 * {@code Float.POSITIVE_INFINITY}).
	 * <li>
	 * {@code 0.0f} is considered by this method to be greater than
	 * {@code -0.0f}.
	 * </ul>
	 *
