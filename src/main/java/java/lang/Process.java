 ...
 *
 * <p>
 * There is no requirement that a process represented by a {@code Process}
 * object execute asynchronously or concurrently with respect to the Java
 * process that owns the {@code Process} object.
 *
 * <p>
...
public abstract class Process
{
	 ...
	 * ProcessBuilder.redirectInput} then this method will return a <a
	 * href="ProcessBuilder.html#redirect-input">null output stream</a>.
	 *
	 * <p>
	 ...
	 * ProcessBuilder.redirectOutput} then this method will return a <a
	 * href="ProcessBuilder.html#redirect-output">null input stream</a>.
	 *
	 * <p>
	 ...
	 * ProcessBuilder.redirectErrorStream} then this method will return a <a
	 * href="ProcessBuilder.html#redirect-output">null input stream</a>.
	 *
	 * <p>
	 * Implementation note: It is a good idea for the returned input stream to
