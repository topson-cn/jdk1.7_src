/*
 * Copyright (c) 2003, 2004, Oracle and/or its affiliates. All rights reserved. ORACLE
...
/**
 * An object to which <tt>char</tt> sequences and values can be appended. The <tt>Appendable</tt>
 * interface must be implemented by any class whose instances are intended to receive formatted
 * output from a {@link java.util.Formatter}.
 *
 * <p>
 * The characters to be appended should be valid Unicode characters as described in <a
 * href="Character.html#unicode">Unicode Character Representation</a>. Note that supplementary
 * characters may be composed of multiple 16-bit <tt>char</tt> values.
 *
 * <p>
...
public interface Appendable {
   ...
   *
   * <p>
   * Depending on which class implements the character sequence <tt>csq</tt>, the entire sequence
   * may not be appended. For instance, if <tt>csq</tt> is a {@link java.nio.CharBuffer} then the
