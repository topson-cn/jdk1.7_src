...
public class Collections
{
	...
	{
		return (list instanceof RandomAccess ? new UnmodifiableRandomAccessList<>(
	 ...
	 * hasPrevious} always return {@code false}.
	 *
	 ...
	 * always throw {@link IllegalStateException}.
	 *
		...
		public Set<Map.Entry<K, V>> entrySet()
		{
			if (entrySet == null)
				entrySet = Collections
						.<Map.Entry<K, V>> singleton(new SimpleImmutableEntry<>(
								k, v));
			return entrySet;
		}
	 ...
	 *             is ineligible for the other collection. (<a
	 *             href="Collection.html#optional-restrictions">optional</a>)
	 * @since 1.5
	 */
