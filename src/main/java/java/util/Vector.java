 ...
 * methods are <em>fail-fast</em>: if the vector is structurally modified at any
 ...
 * Unlike the new collection implementations, {@code Vector} is synchronized. If
 * a thread-safe implementation is not needed, it is recommended to use
 * {@link ArrayList} in place of {@code Vector}.
 *
 * @author Lee Boynton
