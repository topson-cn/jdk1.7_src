 ...
 * {@code headSet}, and {@code tailSet} differ from the like-named
 * {@code SortedSet} methods in accepting additional arguments describing
 * whether lower and upper bounds are inclusive versus exclusive. Subsets of any
...
public interface NavigableSet<E> extends SortedSet<E>
{
	 ...
	 * set is backed by this set, so changes in the returned set are reflected
	 * in this set, and vice-versa. The returned set supports all optional set
