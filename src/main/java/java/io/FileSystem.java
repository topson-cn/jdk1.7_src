/*
 * Copyright (c) 1998, 2005, Oracle and/or its affiliates. All rights reserved. ORACLE
...
abstract class FileSystem {
   ...
   * getCanonicalPath methods in the File class.
   */
  ...
  /**
   * Delete the file or directory denoted by the given abstract pathname, returning
