...
public interface ObjectStreamConstants {
  ...
  /**
   * Bit mask for ObjectStreamClass flag. Indicates a Serializable class defines its own writeObject
   * method.
   */
   ...
   * This version is needed to write streams containing Externalizable data that can be read by
   * pre-JDK 1.1.6 JVMs.
   *
   ...
   * Externalizable classdescriptor flags has SC_BLOCK_DATA enabled. JVM 1.1.6 and greater can read
   * this format change.
   *
   * Enables writing a nonSerializable class descriptor into the stream. The serialVersionUID of a
   * nonSerializable class is set to 0L.
   *
   * @see java.io.ObjectOutputStream#useProtocolVersion(int)
   * @see #SC_BLOCK_DATA
   * @since 1.2
