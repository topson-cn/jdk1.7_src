/*
 * Copyright (c) 1994, 2003, Oracle and/or its affiliates. All rights reserved. ORACLE
...
/**
 * The class implements a buffered output stream. By setting up such an output stream, an
 * application can write bytes to the underlying output stream without necessarily causing a call to
