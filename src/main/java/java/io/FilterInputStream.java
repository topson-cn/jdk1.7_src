/*
 * Copyright (c) 1994, 2010, Oracle and/or its affiliates. All rights reserved. ORACLE
...
/**
 * A <code>FilterInputStream</code> contains some other input stream, which it uses as its basic
 * source of data, possibly transforming the data along the way or providing additional
 * functionality. The class <code>FilterInputStream</code> itself simply overrides all methods of
 * <code>InputStream</code> with versions that pass all requests to the contained input stream.
 * Subclasses of <code>FilterInputStream</code> may further override some of these methods and may
...
public class FilterInputStream extends InputStream {
   ...
   * <p>
   * This method simply performs the call <code>read(b, 0, b.length)</code> and returns the result.
   * It is important that it does <i>not</i> do <code>in.read(b)</code> instead; certain subclasses
   * of <code>FilterInputStream</code> depend on the implementation strategy actually used.
   *
