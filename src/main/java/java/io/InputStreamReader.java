 ...
 * decodes them into characters using a specified {@link java.nio.charset.Charset
 * <code>charset</code>}. The charset that it uses may be specified by name or may be given
...
public class InputStreamReader extends Reader {
   ...
   *
   * <p>
   * If this instance was created with the {@link #InputStreamReader(InputStream, String)}
   * constructor then the returned name, being unique for the encoding, may differ from the name
   * passed to the constructor. This method will return <code>null</code> if the stream has been
   * closed.
   * </p>
   * 
  ...
  /**
   * Tells whether this stream is ready to be read. An InputStreamReader is ready if its input
   * buffer is not empty, or if bytes are available to be read from the underlying byte stream.
   *
   * @exception IOException If an I/O error occurs
   */
