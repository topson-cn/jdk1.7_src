 ...
 * {@link #setLineNumber(int)} and {@link #getLineNumber()} for setting and getting the current line
 * number respectively.
 *
 * <p>
 * By default, line numbering begins at 0. This number increments at every <a href="#lt">line
 * terminator</a> as the data is read, and can be changed with a call to <tt>setLineNumber(int)</tt>
 * . Note however, that <tt>setLineNumber(int)</tt> does not actually change the current position in
 * the stream; it only changes the value that will be returned by <tt>getLineNumber()</tt>.
 *
 * <p>
...
public class LineNumberReader extends BufferedReader {
  ...
  /**
   * Read characters into a portion of an array. Whenever a <a href="#lt">line terminator</a> is
  ...
  /**
   * Read a line of text. Whenever a <a href="#lt">line terminator</a> is read the current line
   ...
   * the stream to this point, and will also reset the line number appropriately.
   *
