 ...
 * the <tt>print</tt> methods found in {@link PrintStream}. It does not contain methods for writing
 * raw bytes, for which a program should use unencoded byte streams.
 *
 * <p>
 * Unlike the {@link PrintStream} class, if automatic flushing is enabled it will be done only when
 * one of the <tt>println</tt>, <tt>printf</tt>, or <tt>format</tt> methods is invoked, rather than
 * whenever a newline character happens to be output. These methods use the platform's own notion of
 * line separator rather than the newline character.
 *
 * <p>
 * Methods in this class never throw I/O exceptions, although some of its constructors may. The
 * client may inquire as to whether any errors have occurred by invoking {@link #checkError
 * checkError()}.
 *
 * @author Frank Yellin
...
public class PrintWriter extends Writer {
  ...
  /**
   * Creates a new PrintWriter, without automatic line flushing, from an existing OutputStream. This
  ...
  /**
   * Creates a new PrintWriter from an existing OutputStream. This convenience constructor creates
  ...
  /**
   * Creates a new PrintWriter, without automatic line flushing, with the specified file name. This
   * convenience constructor creates the necessary intermediate {@link java.io.OutputStreamWriter
   * OutputStreamWriter}, which will encode characters using the
   * {@linkplain java.nio.charset.Charset#defaultCharset() default charset} for this instance of the
   ...
   *         {@link SecurityManager#checkWrite checkWrite(fileName)} denies write access to the file
   *
   * @since 1.5
   */
  ...
  /**
   * Creates a new PrintWriter, without automatic line flushing, with the specified file name and
   * charset. This convenience constructor creates the necessary intermediate
   * {@link java.io.OutputStreamWriter OutputStreamWriter}, which will encode characters using the
   * provided charset.
   *
   * @param fileName The name of the file to use as the destination of this writer. If the file
   *        exists then it will be truncated to zero size; otherwise, a new file will be created.
  ...
  /**
   * Creates a new PrintWriter, without automatic line flushing, with the specified file. This
   * convenience constructor creates the necessary intermediate {@link java.io.OutputStreamWriter
   * OutputStreamWriter}, which will encode characters using the
   * {@linkplain java.nio.charset.Charset#defaultCharset() default charset} for this instance of the
   * Java virtual machine.
   ...
   *        be truncated to zero size; otherwise, a new file will be created. The output will be
   ...
   *
   * @throws SecurityException If a security manager is present and
   *         {@link SecurityManager#checkWrite checkWrite(file.getPath())} denies write access to
   *         the file
   *
   * @since 1.5
   */
  ...
  /**
   * Creates a new PrintWriter, without automatic line flushing, with the specified file and
   * charset. This convenience constructor creates the necessary intermediate
   * {@link java.io.OutputStreamWriter OutputStreamWriter}, which will encode characters using the
   * provided charset.
   *
   ...
   *
   * <p>
   * This method will cause subsequent invocations of {@link #checkError()} to return <tt>true</tt>
   ...
   *
   * <p>
   * This method will cause subsequent invocations of {@link #checkError()} to return <tt>false</tt>
  ...
  /*
   * Exception-catching, synchronized output operations, which also implement the write() methods of
   * Writer
   */
  ...
  /**
   * Writes a string. This method cannot be inherited from the Writer class because it must suppress
   * I/O exceptions.
   * 
  ...
  /**
   * Prints a floating-point number and then terminates the line. This method behaves as though it
   * invokes <code>{@link #print(float)}</code> and then <code>{@link #println()}</code>.
   *
  ...
  /**
   * Prints a double-precision floating-point number and then terminates the line. This method
   * behaves as though it invokes <code>{@link
  ...
  /**
   * Prints an array of characters and then terminates the line. This method behaves as though it
  ...
  /**
   * Prints an Object and then terminates the line. This method calls at first String.valueOf(x) to
  ...
  /**
   * A convenience method to write a formatted string to this writer using the specified format
   * string and arguments. If automatic flushing is enabled, calls to this method will flush the
   * output buffer.
   *
   * <p>
  ...
  /**
   * Writes a formatted string to this writer using the specified format string and arguments. If
   * automatic flushing is enabled, calls to this method will flush the output buffer.
   *
   * <p>
