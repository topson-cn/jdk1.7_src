 ...
 * platforms, in particular, allow a file to be opened for writing by only one <tt>FileWriter</tt>
 ...
 *
 * <p>
 * <code>FileWriter</code> is meant for writing streams of characters. For writing streams of raw
 * bytes, consider using a <code>FileOutputStream</code>.
 *
...
public class FileWriter extends OutputStreamWriter {
  ...
  /**
   * Constructs a FileWriter object given a File object. If the second argument is <code>true</code>
