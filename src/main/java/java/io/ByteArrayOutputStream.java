...
public class ByteArrayOutputStream extends OutputStream {
   ...
   * {@link java.nio.charset.Charset charsetName}. The length of the new <tt>String</tt> is a
   ...
   *
   * @param charsetName the name of a supported {@linkplain java.nio.charset.Charset </code>charset
   *        <code>}
   * @return String decoded from the buffer's contents.
