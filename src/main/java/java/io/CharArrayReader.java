...
public class CharArrayReader extends Reader {
   ...
   *         <tt>buf.length</tt>, or if <tt>length</tt> is negative, or if the sum of these two
   *         values is negative.
   *
   * @param buf Input buffer (not copied)
   ...
   *        the mark. Because the stream's input comes from a character array, there is no actual
