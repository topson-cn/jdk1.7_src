 ...
 * buffer, decoupling read operations from write operations, within limits. A pipe is said to be <a
 * name=BROKEN> <i>broken</i> </a> if a thread that was providing data bytes to the connected piped
...
public class PipedInputStream extends InputStream {
   ...
   * is thrown.
   * <p>
   * If <code>src</code> is an unconnected piped output stream and <code>snk</code> is an
   * unconnected piped input stream, they may be connected by either the call:
   * <p>
   * 
   * <pre>
   ...
   *            {@link #connect(java.io.PipedOutputStream) unconnected}, closed, or if an I/O error
   *            occurs.
   * @since JDK1.1
   */
   ...
   *            <a href=#BROKEN> <code>broken</code></a>, closed, or if an I/O error occurs.
   */
   ...
   *         or if the pipe is {@link #connect(java.io.PipedOutputStream) unconnected}, or <a
