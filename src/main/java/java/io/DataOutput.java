...
public interface DataOutput {
   ...
   * are written. Otherwise, the byte <code>b[off]</code> is written first, then
   * <code>b[off+1]</code>, and so on; the last byte written is <code>b[off+len-1]</code>.
   *
   * @param b the data.
   ...
   * href="DataInput.html#modified-utf-8">modified UTF-8</a> representation of every character in
