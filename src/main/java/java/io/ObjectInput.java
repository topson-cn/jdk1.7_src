...
/**
 * ObjectInput extends the DataInput interface to include the reading of objects. DataInput includes
 * methods for the input of primitive types, ObjectInput extends that interface to include objects,
 * arrays, and Strings.
 *
 * @author unascribed
