...
/**
 * This class implements a character buffer that can be used as an Writer. The buffer automatically
 * grows when data is written to the stream. The data can be retrieved using toCharArray() and
 * toString().
 * <P>
