...
public class PipedReader extends Reader {
  ...
  /**
   * Creates a <code>PipedReader</code> so that it is not yet {@link #connect(java.io.PipedWriter)
   ...
   *            </a>, {@link #connect(java.io.PipedWriter) unconnected}, closed, or an I/O error
   *            occurs.
   */
   ...
   *
   * @exception IOException if the pipe is <a href=PipedInputStream.html#BROKEN> <code>broken</code>
   *            </a>, {@link #connect(java.io.PipedWriter) unconnected}, or closed.
   */
