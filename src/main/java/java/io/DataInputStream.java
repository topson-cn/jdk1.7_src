...
public class DataInputStream extends FilterInputStream implements DataInput {
   ...
   * array <code>b</code>. The number of bytes actually read is returned as an integer. This method
   ...
   * of file, the value <code>-1</code> is returned; otherwise, at least one byte is read and stored
   * into <code>b</code>.
   *
   * <p>
   ...
   *            the stream has been closed and the underlying input stream does not support reading
   ...
   *            been closed and the contained input stream does not support reading after close, or
