...
public class BufferedInputStream extends FilterInputStream {
   ...
   * <code>count</code>, then <code>buf[pos]</code> is the next byte to be supplied as input; if it
   * is equal to <code>count</code>, then the next <code>read</code> or <code>skip</code> operation
   ...
   *            or the stream has been closed by invoking its {@link #close()} method, or an I/O
   *            error occurs.
   * @see java.io.BufferedInputStream#mark(int)
   */
