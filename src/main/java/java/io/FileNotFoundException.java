/*
 * Copyright (c) 1994, 2008, Oracle and/or its affiliates. All rights reserved. ORACLE
 ...
 *
 * <p>
 * This exception will be thrown by the {@link FileInputStream}, {@link FileOutputStream}, and
 * {@link RandomAccessFile} constructors when a file with the specified pathname does not exist. It
 * will also be thrown by these constructors if the file does exist but for some reason is
