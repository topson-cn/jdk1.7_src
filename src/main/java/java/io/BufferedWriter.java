 ...
 *
 * <p>
 * A newLine() method is provided, which uses the platform's own notion of line separator as defined
 * by the system property <tt>line.separator</tt>. Not all platforms use the newline character
 * ('\n') to terminate lines. Calling this method to terminate each output line is therefore
...
public class BufferedWriter extends Writer {
  ...
  /**
   * Our own little min method, to avoid loading java.lang.Math if we've run out of file descriptors
   * and we're trying to print a stack trace.
   */
   ...
   *
   * <p>
   * If the value of the <tt>len</tt> parameter is negative then no characters are written. This is
   * contrary to the specification of this method in the
