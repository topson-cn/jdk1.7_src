...
public abstract class Writer implements Appendable, Closeable, Flushable {
  ...
  /**
   * Closes the stream, flushing it first. Once the stream has been closed, further write() or
   * flush() invocations will cause an IOException to be thrown. Closing a previously closed stream
   * has no effect.
   *
   * @throws IOException If an I/O error occurs
   */
