/*
 * Copyright (c) 2000, 2005, Oracle and/or its affiliates. All rights reserved. ORACLE
...
public interface WritableByteChannel extends Channel {
   ...
   *
   * <p>
   * An attempt is made to write up to <i>r</i> bytes to the channel, where <i>r</i> is the number
   * of bytes remaining in the buffer, that is, <tt>src.remaining()</tt>, at the moment this method
   * is invoked.
   *
   * <p>
   * Suppose that a byte sequence of length <i>n</i> is written, where <tt>0</tt>&nbsp;
   * <tt>&lt;=</tt>&nbsp;<i>n</i>&nbsp;<tt>&lt;=</tt>&nbsp;<i>r</i>. This byte sequence will be
   ...
   * <tt>+</tt>&nbsp;<i>n</i>&nbsp;<tt>-</tt>&nbsp;<tt>1</tt>. Upon return the buffer's position
