...
public class BigInteger extends Number implements Comparable<BigInteger>
{
	...
	public BigInteger add(BigInteger val)
	{
		...
		if (cmp == 0)
			return ZERO;
		int[] resultMag = (cmp > 0 ? subtract(mag, val.mag) : subtract(val.mag,
				mag));
	...
	{
		MutableBigInteger q = new MutableBigInteger(), a = new MutableBigInteger(
	...
	public BigInteger modPow(BigInteger exponent, BigInteger m)
	{
		...
		else
		{
			...
			result = a1.multiply(m2).multiply(y1)
					.add(a2.multiply(m1).multiply(y2)).mod(m);
		}
	...
	private BigInteger oddModPow(BigInteger y, BigInteger z)
	{
		...
		MutableBigInteger q = new MutableBigInteger(), a2 = new MutableBigInteger(
	 ...
	 * @serialField
	 *                  bitLength int the number of bits in the minimal
	 *                  two's-complement representation of this BigInteger
	 * @serialField
	 *                  lowestSetBit int lowest set bit in the twos complement
	 *                  representation
	 */
